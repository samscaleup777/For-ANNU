document.addEventListener('DOMContentLoaded',()=>{
  ...
  const visualMap={'page-home':['/assets/real/fashion-hero.jpg','/assets/real/quran-reading.jpg','/assets/real/safety-laptop.jpg','/assets/real/lifestyle-home.jpg'],'page-quran':['/assets/real/quran-reading.jpg','/assets/real/quran-reading-2.jpg','/assets/real/lifestyle-outdoor.jpg','/assets/real/lifestyle-home.jpg'],'page-safety':['/assets/real/safety-laptop.jpg','/assets/real/safety-laptop-2.jpg','/assets/real/fashion-hero.jpg','/assets/real/lifestyle-outdoor.jpg'],'page-lifestyle':['/assets/real/lifestyle-home.jpg','/assets/real/lifestyle-kitchen.jpg','/assets/real/lifestyle-outdoor.jpg','/assets/real/quran-reading.jpg'],'page-blog':['/assets/real/fashion-wardrobe.jpg','/assets/real/quran-reading-2.jpg','/assets/real/safety-laptop.jpg','/assets/real/lifestyle-kitchen.jpg'],'page-about':['/assets/real/fashion-shopping.jpg','/assets/real/quran-reading.jpg','/assets/real/safety-laptop-2.jpg','/assets/real/lifestyle-home.jpg'],'page-contact':['/assets/real/safety-laptop.jpg','/assets/real/fashion-rack.jpg','/assets/real/lifestyle-kitchen.jpg','/assets/real/quran-reading.jpg']};
  ...
  if(feature&&!feature.querySelector('img')){const featureImages={'page-home':'/assets/real/lifestyle-home.jpg','page-quran':'/assets/real/quran-reading-2.jpg','page-safety':'/assets/real/safety-laptop-2.jpg','page-lifestyle':'/assets/real/lifestyle-kitchen.jpg','page-blog':'/assets/real/fashion-wardrobe.jpg','page-about':'/assets/real/lifestyle-outdoor.jpg','page-contact':'/assets/real/fashion-shopping.jpg'};feature.style.backgroundImage=`linear-gradient(135deg,rgba(18,49,38,.08),rgba(18,49,38,.32)),url('${featureImages[pageClass]||'/assets/section-lifestyle.svg'}')`;feature.setAttribute('aria-label','Annïka section visual')}
