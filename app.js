document.addEventListener('DOMContentLoaded',()=>{
  ...
  const visualMap={'page-home':['/assets/real-fashion-01.jpg','/assets/real-fashion-02.jpg','/assets/real-fashion-03.jpg','/assets/real-fashion-04.jpg'],'page-quran':['/assets/real-fashion-02.jpg','/assets/real-fashion-04.jpg','/assets/real-fashion-01.jpg','/assets/real-fashion-03.jpg'],'page-safety':['/assets/real-fashion-03.jpg','/assets/real-fashion-04.jpg','/assets/real-fashion-01.jpg','/assets/real-fashion-02.jpg'],'page-lifestyle':['/assets/real-fashion-04.jpg','/assets/real-fashion-03.jpg','/assets/real-fashion-02.jpg','/assets/real-fashion-01.jpg'],'page-blog':['/assets/real-fashion-01.jpg','/assets/real-fashion-04.jpg','/assets/real-fashion-02.jpg','/assets/real-fashion-03.jpg'],'page-about':['/assets/real-fashion-03.jpg','/assets/real-fashion-01.jpg','/assets/real-fashion-04.jpg','/assets/real-fashion-02.jpg'],'page-contact':['/assets/real-fashion-02.jpg','/assets/real-fashion-03.jpg','/assets/real-fashion-04.jpg','/assets/real-fashion-01.jpg']};
  ...
  if(feature&&!feature.querySelector('img')){const featureImages={'page-home':'/assets/real-fashion-04.jpg','page-quran':'/assets/real-fashion-02.jpg','page-safety':'/assets/real-fashion-03.jpg','page-lifestyle':'/assets/real-fashion-01.jpg','page-blog':'/assets/real-fashion-04.jpg','page-about':'/assets/real-fashion-03.jpg','page-contact':'/assets/real-fashion-02.jpg'};feature.style.backgroundImage=`linear-gradient(135deg,rgba(18,49,38,.08),rgba(18,49,38,.32)),url('${featureImages[pageClass]||'/assets/section-lifestyle.svg'}')`;feature.setAttribute('aria-label','Annïka section visual')}
